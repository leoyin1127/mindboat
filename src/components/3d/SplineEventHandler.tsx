...
import { LifeGoalsModal } from '../panels/LifeGoalsModal'
import { WelcomePanel } from '../panels/WelcomePanel'
import { JourneyPanel } from '../panels/JourneyPanel'
import { SeagullPanel } from '../panels/SeagullPanel'
...
export const SplineEventHandler: React.FC<SplineEventHandlerProps> = ({
  ...
  useEffect(() => {
    ...
    channel
      .on('broadcast', { event: 'spline_interaction' }, (payload: { payload: SplineEvent }) => {
